...
start_prep = dt.strptime(project_variables["standard"]["arosa_isel_load_start"], "%Y-%m-%dT%H:%M:%S").replace(tzinfo=UTC)
...
AROSA_Isel_FC_preprocessing.write_with_schema(df)
