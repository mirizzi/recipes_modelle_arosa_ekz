...
prod_newest_df=prod_newest_df[["datetime","molinis_inflow [m3/s]"]]
...
prod_newest_df.rename(columns={"molinis_inflow [m3/s]": "pradapunt_inflow"}, inplace=True)
...
isel_df = isel_df[['datetime', 'Pradapunt Inflow (m3/s)']]
# rename column
isel_df.rename(columns={"Pradapunt Inflow (m3/s)": "pradapunt_inflow"}, inplace=True)
...
AROSA_Pradapunt_Meteo_Forecast = dataiku.Dataset("AROSA_Pradapunt_Meteo_Forecast")
meteo_df = AROSA_Pradapunt_Meteo_Forecast.get_dataframe()
...
# Dataset AROSA_PRADAPUNT_Meteo_Hist_temp renamed to AROSA_PRADAPUNT_Hist_temp by dario.panzuto@axpo.com on 2023-12-05 15:49:42
AROSA_PRADAPUNT_Meteo_Hist_temp = dataiku.Dataset("AROSA_PRADAPUNT_Hist_temp")
AROSA_PRADAPUNT_Meteo_Hist_temp.write_with_schema(df)